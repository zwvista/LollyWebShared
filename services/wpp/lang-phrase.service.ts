...
export class LangPhraseService extends BaseService {
  ...
  async getDataByLang(langid: number, filter: string, filterScope: string): Promise<MLangPhrases>;
  async getDataByLang(langid: number, filter: string, filterScope: string, page: number, rows: number): Promise<MLangPhrases>;
  async getDataByLang(langid: number, filter: string, filterScope: string, page?: number, rows?: number): Promise<MLangPhrases> {
